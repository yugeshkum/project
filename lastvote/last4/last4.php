...
$sql = "update result set no_of_votes=no_of_votes+1 where c_no='$db_usn' and d_no=4";
...
<body>
    ...
    <div class="main">
        ...
        <input type="text" name="cno" id="title" placeholder="Candidate Number" />
                ...
                <div class="form-submit">
                    <a href="/lastvote/last4/loc.php" id="submit" class="submit">See list of candidates</a>
                </div>
