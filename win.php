...
$query2 = mysqli_query($conn,"SELECT * FROM result where no_of_votes in (SELECT max(no_of_votes) FROM result group by d_name)");
...
<body>
	...
	<a style="color:white; font-size: 30px; padding-left: 20px;">Candidate Winner</a>
