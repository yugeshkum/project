...
$db_usn=$_GET['usn'];
$db_name=$_GET['usrname'];
$db_dno=$_GET['dno'];
$db_dname=$_GET['dname'];

$sql = "insert into registered (USN,Name,Dep_No,Dep_Name) values('$db_usn','$db_name','$db_dno','$db_dname')";
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" name="usn" type="text" placeholder="USN">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" name="usrname" type="text" placeholder="User Name">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<i class="fa fa-envelope" aria-hidden="true"></i>
						</span>
